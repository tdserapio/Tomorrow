...
while cap.isOpened():    
    ...
    # Draw line threshold
    if tutorial:
        frame = cv2.line(frame, (0, yUp), (5000, yUp), (60, 60, 60), 20)
        frame = cv2.line(frame, (0, yDown), (5000, yDown), (0, 0, 256), 20)
        frame = cv2.line(frame, (xLeft, 0), (xLeft, 5000), (256, 0, 0), 20)
        frame = cv2.line(frame, (xRight, 0), (xRight, 5000), (0, 256, 0), 20)
